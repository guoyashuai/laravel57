...
class Form implements Renderable
{
    ...
    protected function updateRelation($relationsData)
    {
        foreach ($relationsData as $name => $values) {
            ...
            if (array_has($prepared, '__extend__')) {
                ($prepared['__extend__'])($this->model, $prepared[$name]);
                unset($prepared['__extend__']);
            }
            ...
            switch (get_class($relation)) {
                ...
                case Relations\HasMany::class:
                    $this->model->$name()->createMany($prepared[$name]);
                    break;
    ...
    protected function prepareUpdate(array $updates, $oneToOneRelation = false)
    {
        ...
        foreach ($this->builder->fields() as $field) {
            ...
            if(is_array($value) && array_has($value, '__extend__'))
            {
                array_set($prepared, '__extend__', $value['__extend__']);
                unset($value['__extend__']);
            }
